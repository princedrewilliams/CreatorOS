	...
	return (
		<div className="relative">
			<button
				...
				className="flex items-center gap-2 px-3 py-2 rounded-full bg-white/[0.08] hover:bg-white/[0.12] transition-all"
			>
				...
				<span className="text-sm text-white/90 hidden sm:block max-w-[100px] truncate">
				...
				<>
					...
					<div className="absolute right-0 top-full mt-2 w-56 bg-[#0a0a0a] border border-white/10 rounded-xl shadow-2xl z-50 overflow-hidden">
						...
						<button
							...
							className="w-full flex items-center gap-3 px-4 py-3 text-sm text-red-400 hover:bg-white/[0.05] transition-colors"
						>

...
// Icons are defined inline as SVGs below
			...
			<div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
				...
				>
					...
					>
						...
						<span className="text-sm font-medium text-pink-300">Introducing Channel DNA Analyzer</span>
					</motion.div>
					...
					>
						<span className="text-white">Reverse-Engineer What Makes </span>
						...
						<div className="flex flex-col sm:flex-row gap-4 mb-4">
							...
							<div className="flex-1 relative">
								...
								<input
									...
									className="w-full pl-12 pr-4 py-4 rounded-xl bg-gray-a3/50 border border-pink-500/20 text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-pink-500/50 focus:border-pink-500/50 transition-all duration-200 backdrop-blur-sm"
								/>
							</div>
							...
							<div className="flex items-end">
								<button
									...
									className="px-8 py-4 rounded-xl bg-gradient-to-r from-pink-500 to-rose-500 text-white font-semibold text-lg hover:from-pink-600 hover:to-rose-600 focus:outline-none focus:ring-2 focus:ring-pink-500/50 focus:ring-offset-2 focus:ring-offset-gray-12 transition-all duration-200 shadow-lg shadow-pink-500/20 hover:shadow-pink-500/30 hover:scale-[1.02] active:scale-[0.98] whitespace-nowrap"
								>
									Analyze Channel
								</button>
							</div>
				...
				<motion.p
					...
					className="text-center text-gray-400 mb-12 sm:mb-16"
				>
				...
				>
					{features.map((feature, index) => (
						<motion.div
							...
							className="group relative p-6 rounded-2xl bg-gray-a3/30 border border-pink-500/10 backdrop-blur-sm hover:border-pink-500/30 transition-all duration-300"
						>
							{/* Glow effect on hover */}
							<div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-pink-500/0 via-pink-500/5 to-pink-500/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
				...
				<motion.p
					...
					className="text-center text-gray-400 mt-12 sm:mt-16"
				>
					Works on any public YouTube channel
				</motion.p>
			</div>

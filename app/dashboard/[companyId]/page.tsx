...
export default async function DashboardPage({
		...
		if (!isWhopConfigured || !whopsdk) {
			return (
				<div className="flex flex-col items-center justify-center min-h-screen p-8 text-center bg-black text-white">
					<h1 className="text-8 font-bold text-white mb-4">Whop integration unavailable</h1>
					<p className="text-4 text-gray-300 mb-6">
						Add <code className="bg-gray-900 px-2 py-1 rounded text-white">WHOP_API_KEY</code> and related credentials to enable the dashboard preview for Whop data.
					</p>
	...
	try {
		...
		if (!companyId || typeof companyId !== "string" || companyId.trim().length === 0) {
			return (
				<div className="flex flex-col items-center justify-center min-h-screen p-8 text-center bg-black text-white">
					<h1 className="text-8 font-bold text-white mb-4">Invalid Company ID</h1>
					<p className="text-4 text-gray-300 mb-6">
		...
		try {
			...
			return (
				<div className="flex flex-col items-center justify-center min-h-screen p-8 text-center bg-black text-white">
					<h1 className="text-8 font-bold text-white mb-4">Authentication Required</h1>
					<p className="text-4 text-gray-300 mb-6">
		...
		try {
			...
			return (
				<div className="flex flex-col items-center justify-center min-h-screen p-8 text-center bg-black text-white">
					<h1 className="text-8 font-bold text-white mb-4">Access Check Failed</h1>
					<p className="text-4 text-gray-300 mb-6">
			...
			return (
				<div className="flex flex-col items-center justify-center min-h-screen p-8 bg-black text-white">
					<div className="max-w-md w-full text-center">
						<h1 className="text-8 font-bold text-white mb-4">Admin Access Required</h1>
						<p className="text-4 text-gray-300 mb-6">
		...
		try {
			...
			return (
				<div className="flex flex-col items-center justify-center min-h-screen p-8 text-center bg-black text-white">
					<h1 className="text-8 font-bold text-white mb-4">Error Loading Data</h1>
					<p className="text-4 text-gray-300 mb-6">
		...
		return (
			<div className="flex flex-col p-8 gap-4 min-h-screen bg-black text-white">
				<div className="flex justify-between items-center gap-4">
					<h1 className="text-9 text-white">
				...
				<p className="text-3 text-gray-300">
				...
				<div className="p-4 rounded-lg border border-gray-700 bg-gray-900">
					<Text size="2" weight="medium" className="mb-2 text-gray-300">
						Company ID
					</Text>
					<Text size="4" weight="bold" className="text-white font-mono">
						{companyId}
					</Text>
				</div>

				<h3 className="text-6 font-bold text-white">Company data</h3>
				<JsonViewer data={company} />

				<h3 className="text-6 font-bold text-white">User data</h3>
				<JsonViewer data={user} />

				<h3 className="text-6 font-bold text-white">Access data</h3>
		...
		return (
			<div className="flex flex-col items-center justify-center min-h-screen p-8 text-center bg-black text-white">
				<h1 className="text-8 font-bold text-white mb-4">Error Loading Dashboard</h1>
				<p className="text-4 text-gray-300 mb-6">
...
function JsonViewer({ data }: { data: unknown }) {
	return (
		<pre className="text-2 border border-gray-700 rounded-lg p-4 bg-gray-900 max-h-72 overflow-y-auto">
			<code className="text-gray-300">{JSON.stringify(data, null, 2)}</code>
		</pre>
	);
}

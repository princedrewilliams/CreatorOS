...
"[project]/app/api/channel-analyze/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$openai$40$6$2e$10$2e$0$2f$node_modules$2f$openai$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/openai@6.10.0/node_modules/openai/index.mjs [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$openai$40$6$2e$10$2e$0$2f$node_modules$2f$openai$2f$client$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__OpenAI__as__default$3e$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/openai@6.10.0/node_modules/openai/client.mjs [app-route] (ecmascript) <export OpenAI as default>");
;
;
...
function commonKeywords(titles, top = 12) {
    const counts = {};
    ...
    return Object.entries(counts).sort((a, b)=>b[1] - a[1]).slice(0, top).map(([word, count])=>({
            word,
            count
        }));
}
...
function deriveMetrics(videos) {
    ...
    const averageTitleLength = videos.reduce((sum, v)=>sum + (v.title?.length || 0), 0) / videos.length;
...
function buildHeuristicAnalysis(payload) {
    ...
    const simple = (summary, insights, scoreBoost = 0)=>({
...
async function POST(req) {
    try {
        ...
        let analysis = buildHeuristicAnalysis(payload);
        if (openaiKey) {
            const client = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$openai$40$6$2e$10$2e$0$2f$node_modules$2f$openai$2f$client$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__OpenAI__as__default$3e$__["default"]({
                apiKey: openaiKey
            });
            const prompt = `
...
`;
            const completion = await client.chat.completions.create({
                ...
                messages: [
                    {
                        role: "system",
                        content: "You are a precise, concise YouTube channel analyst."
                    },
                    {
                        role: "user",
                        content: prompt
...
//# sourceMappingURL=%5Broot-of-the-server%5D__21972c70._.js.map